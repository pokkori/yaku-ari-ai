...
export const KEYWORDS: Record<string, KeywordData> = {
  "myakuari-line-signs": {
    ...
    features: [
      { icon: "💬", title: "LINE内容分析", text: "メッセージの言葉遣い・頻度・絵文字使用パターンからAIが脈あり度を判定" },
      { icon: "🔍", title: "心理解析", text: "男女の心理パターンをAIが学習。返信速度・内容の変化を総合判断" },
      { icon: "📊", title: "スコア表示", text: "脈あり確率をパーセントで表示。アドバイスと改善ポイントも提案" },
    ],
    faqs: [
  ...
  "kare-kioku-aru-sain": {
    ...
    features: [
      { icon: "👀", title: "行動パターン分析", text: "目が合う頻度、近づいてくる距離感、会話の内容などから脈あり度を判断" },
      { icon: "💡", title: "男性心理解説", text: "男性特有の好意表現パターンをAIが解析。分かりにくいサインも見逃さない" },
      { icon: "✅", title: "具体的アドバイス", text: "現状の脈あり度に応じた次のアクションをAIが提案" },
    ],
    faqs: [
  ...
  "line-henshin-hayai-imi": {
    ...
    features: [
      { icon: "⚡", title: "返信速度分析", text: "返信スピードのパターンをAIが分析。「既読後すぐ返信」「深夜でも反応」などを評価" },
      { icon: "📱", title: "文章内容チェック", text: "返信内容の質（質問があるか、話を広げるかなど）を総合判断" },
      { icon: "❤️", title: "脈あり度スコア", text: "返信速度＋内容から脈あり確率をスコア化して表示" },
    ],
    faqs: [
  ...
  "nanpa-myakuari-signs": {
    ...
    features: [
      { icon: "💝", title: "好意行動チェック", text: "食事・デートへの誘い、連絡頻度の増加、優しさの変化などを分析" },
      { icon: "🧠", title: "心理パターン学習", text: "男性の恋愛心理をAIが学習。言葉では言わない本音を行動から読み解く" },
      { icon: "📋", title: "状況別アドバイス", text: "職場・友人関係・マッチングアプリなど状況に応じた判断と次の一手を提案" },
    ],
    faqs: [
  ...
  "joshi-myakuari-behavior": {
    ...
    features: [
      { icon: "👩", title: "女性心理分析", text: "女性特有の好意表現（さりげない接触、話題への興味など）をAIが解析" },
      { icon: "💬", title: "会話パターン診断", text: "話の内容、質問の仕方、返事の温度感から脈あり度を判断" },
      { icon: "🌹", title: "恋愛アドバイス", text: "現状から次のステップへの具体的なアプローチ方法を提案" },
    ],
    faqs: [
  ...
  "date-myakuari-check": {
    ...
    features: [
      { icon: "📅", title: "デート行動分析", text: "デート中の態度・話題・次回の提案有無などをAIが総合評価" },
      { icon: "⏰", title: "時間・距離チェック", text: "デートの長さ、帰り際の態度、別れ際の言葉などを分析" },
      { icon: "🎯", title: "次の一手提案", text: "デート後のフォロー方法から告白のタイミングまでAIがアドバイス" },
    ],
    faqs: [
  ...
  "line-kigou-kimochi": {
    ...
    features: [
      { icon: "👁️", title: "既読スルー分析", text: "既読後の返信遅延パターン・頻度を分析。単純な忙しさか、意図的な距離かを判断" },
      { icon: "📊", title: "関係性評価", text: "これまでの会話履歴と合わせて総合的な脈あり度を評価" },
      { icon: "💡", title: "対処法アドバイス", text: "既読スルーされた後の最適な対応方法をシチュエーション別に提案" },
    ],
    faqs: [
  ...
  "myakuari-versus-kimai": {
    ...
    features: [
      { icon: "⚖️", title: "脈あり/なし判定", text: "複数のサインを総合的に分析。脈ありか脈なしかをAIが明確に判断" },
      { icon: "📝", title: "具体的な違い解説", text: "脈あり・脈なしの具体的な行動の違いを分かりやすく説明" },
      { icon: "🔄", title: "状況改善アドバイス", text: "脈なしの場合の挽回方法や、より脈ありに近づくためのアクションを提案" },
    ],
    faqs: [
  ...
  "sukinahito-line-check": {
    ...
    features: [
      { icon: "✉️", title: "LINE内容チェック", text: "送る前に内容をAIに確認。相手の心理に響くメッセージか事前評価" },
      { icon: "⏱️", title: "送信タイミング分析", text: "相手の生活リズムや返信パターンを考慮した最適な送信タイミングを提案" },
      { icon: "📈", title: "関係進展サポート", text: "LINEを通じた関係の深め方、デートへの誘い方まで総合的にサポート" },
    ],
    faqs: [
  ...
  "kokuhaku-timing-myakuari": {
    ...
    features: [
      { icon: "💌", title: "告白タイミング診断", text: "現在の脈あり度から告白のベストタイミングをAIが判断" },
      { icon: "🎯", title: "成功率分析", text: "現状での告白成功確率を算出。準備が必要な場合はステップを提案" },
      { icon: "📋", title: "告白シナリオ提案", text: "どこで・どのように告白するかまで、状況に応じたシナリオを提案" },
    ],
    faqs: [
